...
module.exports = {
  ...
  setDiscoverable: function(discoverableDuration) {
    cordova.exec(null, null, "BluetoothSerial", "setDiscoverable", [
      discoverableDuration
    ]);
  },
  printBase64: function(success, failure, str, align) {
    cordova.exec(success, failure, "BluetoothSerial", "printBase64", [
      str,
      align
    ]);
  }
